...
Where:  
- $\sigma_{pred}$ is calculated as $\sigma_{pred} = \sqrt{\dfrac{1}{n} \sum_{i=1}^{n} (pred_i - \mu_{pred})^2}$  
- $\sigma_{obs}$ is calculated as $\sigma_{obs} = \sqrt{\dfrac{1}{n} \sum_{i=1}^{n} (obs_i - \mu_{obs})^2}$   

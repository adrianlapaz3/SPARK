...
#' @param metric The selection metric can be RRMSE, MAPE or KGE. KGE is particularly useful when the estimate needs to accurately reflect the variability at the observed extremes
...
#' )
#'   
linear_model <- function(VIs, y, experiment, train_exp, test_exp, model_degree, metric = "kge", orcutt = 0, cook_distance = 0) {
  
  best_metric_mod1 = Inf; best_model_mod1 = 0; best_train_VI_mod1 = 0; best_coeficients_mod1 = 0; best_bands_mod1 = 0; best_pred_mod1 = 0; best_test_VI_mod1 = 0
  best_metric_mod2 = Inf; best_model_mod2 = 0; best_train_VI_mod2 = 0; best_coeficients_mod2 = 0; best_bands_mod2 = 0; best_pred_mod2 = 0; best_test_VI_mod2 = 0
  best_metric_mod3 = Inf;best_model_mod3 = 0; best_train_VI_mod3 = 0; best_coeficients_mod3 = 0; best_bands_mod3 = 0; best_pred_mod3 = 0; best_test_VI_mod3 = 0
  best_metric_mod4 = Inf;best_model_mod4 = 0; best_train_VI_mod4 = 0; best_coeficients_mod4 = 0; best_bands_mod4 = 0; best_pred_mod4 = 0; best_test_VI_mod4 = 0
  best_metric_mod5 = Inf;best_model_mod5 = 0; best_train_VI_mod5 = 0; best_coeficients_mod5 = 0; best_bands_mod5 = 0; best_pred_mod5 = 0; best_test_VI_mod5 = 0
        ...
        if (pvalue < 0.05 & N > 0.05 & H > 0.05 & I > 0.05 & L > 0.05){
          ...
          if (metric == "kge" | metric == "KGE"){
            ...
            for (exp in train_exp) {
              ...
              if (train_KGE_exp > 0){train_KGE_exp = 1 - train_KGE_exp}

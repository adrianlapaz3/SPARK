...
#' @param lables_treat Vector indicating the sequence of labels treatment breaks, e.g. c("0 kg N/ha", "60 kg N/ha", "120 kg N/ha", "180 kg N/ha", "240 kg N/ha")
#'
  ...
  suppressWarnings({
    ...
    if(n_models > 0 ){
      ...
      VI_x_lab = function(band_string) {
        ...
        processed_string = gsub("\\(0", "(", processed_string)
